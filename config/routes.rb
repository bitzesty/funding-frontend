  ...
  scope '/application', module: 'funding_application', as: :funding_application do
    ...
    scope 'gp-open-medium', module: 'gp_open_medium', as: :gp_open_medium do
      ...
      scope '/:application_id' do
        ...
        get 'any-formal-designation', to: 'heritage_formal_designation_description#show'
        put 'any-formal-designation', to: 'heritage_formal_designation_description#update'
        ...
        get 'delivered-by-a-partnership', to: 'is_partnership#show'
        put 'delivered-by-a-partnership', to: 'is_partnership#update'
